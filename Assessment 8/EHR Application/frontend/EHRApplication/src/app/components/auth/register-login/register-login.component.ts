...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, LoginComponent, PatientRegistrationComponent, ProviderRegistrationComponent],
...
export class RegisterLoginComponent {
  ...
  setActiveForm(form: string): void {
    ...
    }else if (form === 'providerRegister') {
      this.providerRegistration = true;
      this.isLogin = false;
      this.patientRegistration = false;
    } else if (form === 'patientRegister') {
...
//     this.patientRegisterForm.get(fieldName)?.valueChanges.subscribe((value) => {
//       if (value) {
...
//           this.patientRegisterForm.get(fieldName)?.setValue(sanitizedValue, {
//             emitEvent: false, 
//           });
//         }
//       }
...
//         this.patientRegisterForm.get('file')?.setErrors({ invalidType: true });
//         if (event.target instanceof HTMLInputElement) {
//           event.target.value = ''; // Clear invalid input
//         }
//         // return; // Exit if invalid type
//       } else {
//         this.patientRegisterForm.get('file')?.setErrors(null);
//       }
...
//       this.patientRegisterForm.patchValue({ file });
//       this.patientRegisterForm.get('file')?.updateValueAndValidity();
...
//     Object.keys(this.patientRegisterForm.controls).forEach(field => {
//       const value = this.patientRegisterForm.get(field)?.value;
